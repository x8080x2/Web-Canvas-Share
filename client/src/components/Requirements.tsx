    ...
    <section className="py-24 bg-card/30 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          >
            <Badge variant="outline" className="mb-4 border-secondary/50 text-secondary">Requirements</Badge>
            ...
            <Card className="rounded-3xl overflow-hidden border border-white/10 shadow-2xl relative h-64 w-full bg-transparent">
              <img 
          ...
          <div className="w-full lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-6">
            {requirements.map((req, index) => (
              ...
              >
                <Card className="bg-background/50 border border-white/5 p-6 rounded-2xl hover:bg-white/5 transition-colors h-full">
                  <div className="flex justify-between items-start mb-4">
                    <div className="w-12 h-12 rounded-full bg-secondary/20 flex items-center justify-center">
                      <req.icon className="w-6 h-6 text-secondary text-glow-cyan" />
                    </div>
                    <Badge variant="secondary" className="bg-secondary/10 text-secondary border-none">{req.badge}</Badge>
                  </div>
